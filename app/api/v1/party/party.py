...
# def _find_party_by_id(pid: str) -> dict[str, Any] | None:
#     pid = _norm_id(pid)
...
# async def _broadcast_party_event(party: dict, payload: dict) -> None:
...
# async def _broadcast_party_state_snapshot(party: dict, exclude_host: bool = False) -> None:
#     """
...
# @router.get("/party")
# async def get_party(
#     includeState: Annotated[bool, Query()] = False,
#     includeMemberStates: Annotated[bool, Query()] = False,
...
#     data: dict,
#     request: Request,
#     db_match: Annotated[AsyncSession, Depends(get_matchmaking_session)],
...
#     request: Request,
#     disband: Annotated[bool, Query()] = False,
#     db_sessions: AsyncSession = Depends(get_sessions_session),
# ):
#     user_id = await _get_current_user_id(request, db_sessions)
...
# def _append_join_order_and_indices(party: dict, joining_user_id: str) -> None:
...
#     party_id: str,
#     request: Request,
#     autoJoin: Annotated[bool, Query(alias="autoJoin")] = False,
#     key: Annotated[int | None, Query(alias="key")] = None,
#     db_sessions: AsyncSession = Depends(get_sessions_session),
